...
const { Service } = require('./Service.js'); // Import Service model
...
const port = process.env.PORT || 3001; // Set port to environment variable or default to 3001
const app = express();
...
const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: process.env.USER, // Email user from environment variables
...
// Route to delete a service by admin
